...
import com.bluemobi.dylan.R;

import cn.bluemobi.dylan.adapter.BaseMainAdapter;
import cn.bluemobi.dylan.adapter.BaseSubAdapter;
import cn.bluemobi.dylan.callback.BaseCallBack;
import cn.bluemobi.dylan.callback.MainRecyclerViewCallBack;
import cn.bluemobi.dylan.callback.SubRecyclerViewCallBack;
import cn.bluemobi.dylan.simple.BaseSimpleAdapter;
import cn.bluemobi.dylan.util.L;
...
public class LauncherView extends FrameLayout {
    ...
    protected RecyclerView getMain(Context context, AttributeSet parentAttrs) {
        ...
        RecyclerView.ItemAnimator itemAnimator = new LauncherItemAnimator();
...
//                        inMainRegion = true;
                        ...
                        pressedView.startDrag(ClipData.newPlainText(DESCRIPTION, MAIN),
                                new LauncherDragShadowBuilder(pressedView), mSelected, 0);
                    }
                }
            }
        });
    ...
    protected Dialog createSubDialog() {
        Dialog dialog = new Dialog(getContext(), R.style.LauncherViewTheme);
...
//            }
     ...
     * 默认使用 {@link LauncherDragShadowBuilder} 实现 自定义时请重写该方法
     *
     * @param view 被拖动item 的 root view
     * @return
     */
    protected DragShadowBuilder getShadowBuilder(View view) {
        return new LauncherDragShadowBuilder(view);
    }
    ...
    public interface DragListener {
         ...
         * 开始拖拽
         *
         * @param parent parent is LauncherView
         * @param startX start touch x relative launcher view
         * @param startY start touch y relative launcher view
